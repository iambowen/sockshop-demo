...
sed -i s/"address:\s\{1,\}[0-9]\{1,3\}.[0-9]\{1,3\}.[0-9]\{1,3\}.[0-9]\{1,3\}"/"address: $SC_HOST"/g conf/chassis.yaml
sed -i s/"serverUri:\s\{1,\}[0-9]\{1,3\}.[0-9]\{1,3\}.[0-9]\{1,3\}.[0-9]\{1,3\}"/"address: $SC_HOST"/g conf/chassis.yaml
